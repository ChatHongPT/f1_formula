...
- **실시간 F! Fomula 시뮬레이션** : SVG 기반 F1 트랙에서 자동차 애니메이션
- **F1 Formula 대시보드** : 포디움, 팀 순위, 피트스탑, 랩타임 실시간 표시
- **Interactive UI** : 탭 기반 데이터 전환 및 드라이버 선택
...
## 웹 실행 영상
![화면 기록 2025-09-10 오전 9 32 41 (2) (1)](https://github.com/user-attachments/assets/2aee28fa-c5e5-49e2-a9cf-36cd8b1fa183)
